...
export default function MsellerSidebar({
  ...
  const planTheme = {
    ...
    standard: { background: "linear-gradient(180deg,#0f2f4b 0%,#0b5260 54%,#0f766e 100%)", mutedText: "text-cyan-100/75", avatar: "bg-cyan-200 text-slate-950", activeBar: "bg-cyan-300", navIdle: "text-cyan-50/80 hover:bg-cyan-200/[0.10] hover:text-white", navActive: "bg-cyan-100/[0.17] text-white ring-1 ring-cyan-100/15", icon: "text-cyan-100", control: "text-cyan-100/90", userChip: "bg-cyan-100/[0.09] border-cyan-100/15", logout: "bg-cyan-100/[0.08] text-cyan-50 border-cyan-100/15 hover:bg-cyan-100/[0.16] hover:text-white" },
    premium: { background: "linear-gradient(180deg,#123b42 0%,#0b665f 52%,#087e70 100%)", mutedText: "text-emerald-100/80", avatar: "bg-amber-300 text-amber-950", activeBar: "bg-amber-300", navIdle: "text-emerald-50/85 hover:bg-amber-100/[0.08] hover:text-white", navActive: "bg-amber-100/[0.14] text-white ring-1 ring-amber-100/20", icon: "text-amber-100", control: "text-amber-100/90", userChip: "bg-amber-100/[0.08] border-amber-100/15", logout: "bg-amber-100/[0.08] text-emerald-50 border-amber-100/15 hover:bg-amber-100/[0.16] hover:text-white" },
