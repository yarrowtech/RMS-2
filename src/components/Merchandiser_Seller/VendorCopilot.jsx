...
const GUIDES = {
  ...
  "product-list": { title: "Product List", summary: "Keep operational SKU, variant and stock data accurate.", steps: ["Add SKU and stock accurately.", "Use variants for colour, size or pack inventory.", "Keep catalogue details aligned."], next: "catalogue", cta: "Update catalogue" },
...
export default function VendorCopilot({ activeTab, onNavigate }) {
  ...
  const localAsk = () => {
    ...
    else if (query.includes("product") || query.includes("catalogue") || query.includes("variant")) setReply("Use My Catalogue for retailer-facing listings. Add photo, price, MOQ and description; use the optional variant matrix for colour, size or pack options.");
