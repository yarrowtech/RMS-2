...
const PanelPlatformFinance = () => {
  ...
  return <div className="space-y-5">
    ...
    <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">{[
      ...
      ['Retailer revenue', money(summary.retailer_captured_revenue), IndianRupee, 'bg-violet-50 text-violet-700'],
      ['Retailer payment pending', money(summary.retailer_pending_subscription_value), Clock, 'bg-orange-50 text-orange-700'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {activeTab === 'retailers' && (
          <RetailersTab
            ...
            onConsumeOnboarding={() => setPendingOnboarding(null)}
          />
        )}

        {activeTab === 'onboarding' && (
          <SuperAdminOnboardingRequests
            onCreateTenant={(item) => { setPendingOnboarding(item); setActiveTab('retailers'); }}
          />
        )}
