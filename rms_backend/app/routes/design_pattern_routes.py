...
async def create_sample_job_order(sample_id: str, payload: dict, ctx: dict = Depends(require_design_or_production)):
    ...
    if pack: line["tech_pack"]={k:pack.get(k) for k in ("tech_pack_no","version","design_no","style_name","department","description","fabric_notes","fabric_references","measurement_rows","construction_notes","artwork_notes","trims_items","colourways","sketch_images","details_images","artwork_images","trims_images","colourway_images")}
