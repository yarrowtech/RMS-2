...
async def razorpay_webhook(request: Request):
    ...
    from .retailer_subscription_routes import process_retailer_renewal_payment_link_webhook, process_retailer_upgrade_payment_link_webhook
    ...
    upgrade_result = await process_retailer_upgrade_payment_link_webhook(event, event_id)
